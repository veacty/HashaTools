...
public class ToolsMessages extends ConfigExtender {
  ...
  public static String TELEPORT$START = "&6teleport...";
  public static String TELEPORT$SUCCESS = "&aTeleport success";
  public static String TELEPORT$ALREADY = "&cYou are already teleporting";
  public static String TELEPORT$CANCELED = "&cTeleport Canceled";
